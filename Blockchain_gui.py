...
class Blockchain:
	...
	def add_data(self):
		...
		id_b = tk.Label(win2 , text = "Enter ID: ")
	...
	def see_records(self):
		...
		tk.Label(win2 , text = "Enter the ID").pack()
		id_field = tk.Entry(win2)
		id_field.pack()
...
bc = Blockchain()
win = tk.Tk()
win.title("HealthChain")
win.geometry("400x300")

tk.Label(win , text = "!! Welcome to HealthChain !!").pack(pady = 5)
